...
public class CustomListAdapter extends BaseAdapter {
    ...
    public CustomListAdapter(Activity activity, List<Dokter> Dokter) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView kelas = (TextView) convertView.findViewById(R.id.text_sp);
        ImageView imageView = (ImageView) convertView.findViewById(R.id.iconid);
        Dokter m = Dokter.get(position);
        nama.setText("Nama : "+ m.get_nama());
        kelas.setText("Spesialis : "+ m.get_sp());
        return convertView;
    }
}
